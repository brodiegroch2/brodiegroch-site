        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none dark:prose-invert">
            <div className="space-y-12">
              {/* Direct Line Section */}
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 font-inter text-gray-900 dark:text-white">Direct Line</h2>
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 font-inter text-gray-900 dark:text-white">What I&apos;m Open To</h2>
              ...
              {/* Newsletter Section */}
              <div>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 font-inter text-gray-900 dark:text-white">Stay on My Radar</h2>
                ...
                <p className="mt-4 text-xs md:text-sm text-gray-600 dark:text-gray-400 italic">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 md:px-8 py-3 bg-green-600 text-white rounded-lg font-semibold shadow hover:bg-green-700 transition-colors inline-flex items-center gap-2 justify-center text-sm md:text-base"
              >
